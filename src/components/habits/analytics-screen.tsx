...
function SegmentedControl({ options, value, onChange }: { options: { id: string; label: string }[]; value: string; onChange: (v: string) => void }) {
  return (
    ...
    <Card className={CARD_BASE}>
      <CardContent className="p-5">
        ...
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-border/30">
          ...
          <div className="flex items-center justify-end gap-1.5 mt-0 pt-0">
